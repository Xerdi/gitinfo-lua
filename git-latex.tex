...
\begin{document}
    ...
    \begin{abstract}
        ...
        For \LaTeX{} it provides a set of standard macros for displaying basic information or setting the project directory, and a set of advanced macros for commits and tags.
        The advanced macros also have iterating variants in order to generate changelogs or display multiple authors.
    \end{abstract}
