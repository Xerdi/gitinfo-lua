...
\makeindex[title={Macro's},columns=1]
...
%    For changing contents depending on whether the version is dirty or not one can use \cmd{\ifgitdirty}\DescribeMacro{\ifgitdirty}.\\
